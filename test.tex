...
% remove backslash
\(\sin \cos \tan \cot \arcsin \gcd \deg \exp \sup \inf \d \ln \log \operatorname{xyz}\).
% operators
...
% arrows
\(\mapsto \Downarrow \nearrow \nwarrow \searrow \swarrow \Uparrow \updownarrow \Updownarrow \to \uparrow \rightarrow \Rightarrow \leftarrow \Leftarrow \leftharpoondown \leftharpoonup \leftrightarrow \Leftrightarrow \gets \iff \downarrow \).
